...
FileIO.save("Xa_heuristico_1_MP65.jld2","RH",Xa1_MP)
FileIO.save("Xe_heuristico_1_MP65.jld2","RH",Xe1_MP)
FileIO.save("Y_heuristico_MP65.jld2","RH",Y1_MP)
FileIO.save("Ta_heuristico_1_MP65.jld2","RH",Ta1_MP)
FileIO.save("Ta_heuristico_2_MP65.jld2","RH",Ta2_MP)
FileIO.save("Ta_heuristico_3_MP65.jld2","RH",Ta3_MP)
FileIO.save("Ta_heuristico_4_MP65.jld2","RH",Ta4_MP)
FileIO.save("Te_heuristico_1_MP65.jld2","RH",Te1_MP)
FileIO.save("Te_heuristico_2_MP65.jld2","RH",Te2_MP)
FileIO.save("Te_heuristico_3_MP65.jld2","RH",Te3_MP)
FileIO.save("Te_heuristico_4_MP65.jld2","RH",Te4_MP)
FileIO.save("Tempo_heuristicoMP65.jld2","RH",Tempo_MP)
#------------------------------------------------------------------------------------------
...
FileIO.save("Xa_heuristico_1_MC65.jld2","RH",Xa1_MC)
FileIO.save("Xe_heuristico_1_MC65.jld2","RH",Xe1_MC)
FileIO.save("Y_heuristico_MC65.jld2","RH",Y1_MC)
FileIO.save("Ta_heuristico_1_MC65.jld2","RH",Ta1_MC)
FileIO.save("Ta_heuristico_2_MC65.jld2","RH",Ta2_MC)
FileIO.save("Ta_heuristico_3_MC65.jld2","RH",Ta3_MC)
FileIO.save("Ta_heuristico_4_MC65.jld2","RH",Ta4_MC)
FileIO.save("Te_heuristico_1_MC65.jld2","RH",Te1_MC)
FileIO.save("Te_heuristico_2_MC65.jld2","RH",Te2_MC)
FileIO.save("Te_heuristico_3_MC65.jld2","RH",Te3_MC)
FileIO.save("Te_heuristico_4_MC65.jld2","RH",Te4_MC)
FileIO.save("Tempo_heuristicoMC65.jld2","RH",Tempo_MC)
...
FileIO.save("Xa_exato_MP65.jld2","RH",Xa_exato_MP)
FileIO.save("Xe_exato_MP65.jld2","RH",Xe_exato_MP)
FileIO.save("Y_exato_MP65.jld2","RH",Y_exato_MP)
FileIO.save("Ta_exato_MP65.jld2","RH",Ta_exato_MP)
FileIO.save("Te_exato_MP65.jld2","RH",Te_exato_MP)
FileIO.save("Tempo_exatoMP65.jld2","RH",Tempo_exato_MP)
FileIO.save("Gap_exatoMP65.jld2","RH",Gap_MP)
...
FileIO.save("Xa_exato_MC65.jld2","RH",Xa_exato_MC)
FileIO.save("Xe_exato_MC65.jld2","RH",Xe_exato_MC)
FileIO.save("Y_exato_MC65.jld2","RH",Y_exato_MC)
FileIO.save("Ta_exato_MC65.jld2","RH",Ta_exato_MC)
FileIO.save("Te_exato_MC65.jld2","RH",Te_exato_MC)
FileIO.save("Tempo_exatoMC65.jld2","RH",Tempo_exato_MC)
FileIO.save("Gap_exatoMC65.jld2","RH",Gap_MC)
...
FileIO.save("Xa_heuristico_1_CO65.jld2","RH",XaC1)
FileIO.save("Xe_heuristico_1_CO65.jld2","RH",XeC1)
FileIO.save("Y_heuristico_CO65.jld2","RH",YC1)
FileIO.save("Ta_heuristico_1_CO65.jld2","RH",TaC1)
FileIO.save("Ta_heuristico_2_CO65.jld2","RH",TaC2)
FileIO.save("Ta_heuristico_3_CO65.jld2","RH",TaC3)
FileIO.save("Ta_heuristico_4_CO65.jld2","RH",TaC4)
FileIO.save("Te_heuristico_1_CO65.jld2","RH",TeC1)
FileIO.save("Te_heuristico_2_CO65.jld2","RH",TeC2)
FileIO.save("Te_heuristico_3_CO65.jld2","RH",TeC3)
FileIO.save("Te_heuristico_4_CO65.jld2","RH",TeC4)
FileIO.save("Tempo_heuristicoCO65.jld2","RH",Tempo_C)
...
FileIO.save("Xa_exato_CO65.jld2","RH",Xa_exato_compromisso)
FileIO.save("Xe_exato_CO65.jld2","RH",Xe_exato_compromisso)
FileIO.save("Y_exato_CO65.jld2","RH",Y_exato_compromisso)
FileIO.save("Ta_exato_CO65.jld2","RH",Ta_exato_compromisso)
FileIO.save("Te_exato_CO65.jld2","RH",Te_exato_compromisso)
FileIO.save("Tempo_exatoCO65.jld2","RH",Tempo_exato_compromisso)
FileIO.save("Gap_exatoCO65.jld2","RH",Gap_exatoC)
